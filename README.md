...
O **Box Model** é a representação em "caixa", feita pelo navegador, de cada elemento html. Cada **Box Model** possui em ordem,o **content**, o **padding**,o **border** e o **margin**.
